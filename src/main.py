...
def main():
    ...
    industry_analysis_task = tasks.industry_analysis_task(industry_analysis_agent, meeting_context, meeting_context)
    ...
    #Creating the crew from above agents and tasks
    crew = Crew(
